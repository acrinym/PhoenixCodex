...
namespace GPTExporterIndexerAvalonia.Converters
{
    ...
    public class BoolToBrushConverter : IValueConverter
    {
        public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            {
                return new SolidColorBrush(Color.FromRgb(255, 193, 7)); // Amber color for modified indicator
            }
            return new SolidColorBrush(Color.FromRgb(200, 200, 200)); // Gray for unmodified
        }
